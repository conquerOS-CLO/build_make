...
ifneq ($(CONQUER_BUILD),)
include vendor/conquer/config/BoardConfigConquer.mk
endif
...
ifneq ($(CONQUER_BUILD),)
ifneq ($(wildcard device/conquer/sepolicy/common/sepolicy.mk),)
## We need to be sure the global selinux policies are included
## last, to avoid accidental resetting by device configs
$(eval include device/conquer/sepolicy/common/sepolicy.mk)
endif
endif
